...
public class DragAndDropUsingOwnMethod {
	public static void main(String[] args) throws InterruptedException {
		...
		//Drag and Drop the element from source to particular position defined
		actions.dragAndDropBy(itemToBeDragSource, 160, 10).build().perform();
	}
}
...
public class assertTruePassingCondition {
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("Is Checkbox displayed - " + checkBoxIsDisplayed);
		
		/*----------------------------------------Assert True----------------------------------------------------*/
		//If checkbox is present on the page then, condition becomes true otherwise fails.

...
public class DragAndDropEventUsingJavaScriptExecutor {
	public static void main(String[] args) throws InterruptedException {
		...
		//Drag and drop method that moves the element from source to destination.
		actions.dragAndDrop(itemToBeDragSource, itemWhereToDropDestination).build().perform();
	}
}